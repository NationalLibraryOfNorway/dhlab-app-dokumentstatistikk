...
def difference(first, second, rf, rs, years=(1980, 2000),smooth=1, corpus='bok'):
    ...
    # TODO: fix except block depending on variables initialized in try block
    try:
    ...
    if urns != None:
        ...
        for word in words:
            try:
                ...
                # TODO: Is this supposed to be `pass`?
                True
